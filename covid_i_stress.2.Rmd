...
```{r fi1_import}
knitr::include_graphics(wdir("COVIDiSTRESS/Fig1.png"))
```
...
agg_png(file = wdir("COVIDiSTRESS/Fig2.png"), width = 1000, height = 700, res = 144)
mid <- 34
...
dev.off()
knitr::include_graphics(wdir("COVIDiSTRESS/Fig2.png"))
...
agg_png(file = wdir("COVIDiSTRESS/Fig4.png"), width = 1000, height = 700, res = 144)
m5plot + labs(title = "", x = "Welfare State Strength", y = "Coronavirus Concerns, Personal") +
  scale_color_manual(name="Government\nIntervention",
    ...
    theme(panel.background = element_blank(),
          ...
          axis.title = element_text(size = 14))
dev.off()
knitr::include_graphics(wdir("COVIDiSTRESS/Fig4.png"))
