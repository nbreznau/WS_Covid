...
agg_png(file = wdir("COVIDiSTRESS/Fig1.png"), width = 1200, height = 1020,  res = 144)
...
```{r extrafig1, include = F}
agg_png(file = wdir("COVIDiSTRESS/Fig1_free.png"), width = 1200, height = 1020,  res = 144)
ggplot(data=deaths_longC, aes(x=date , y=dead_lead_log, group=Country, color=Country)) +
    geom_line() +
  labs(x= "", y = "Outbreak Severity (log deaths, 18 day lead)") +
  annotate("text", x= as.Date("2020-01-21"), y= 5, 
