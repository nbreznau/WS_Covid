...
m41 <- lm(behave ~ dpm4 + chi2, data = df)

m42 <- lm(behave ~ dpm4 + gap2 + chi2, data = df)

m43 <- lm(behave ~ dpm4 + gap2 + chi2 + gini_disp , data = df)

m44 <- lm(behave ~ dpm4 + gap2 + chi2 + soc_spend , data = df)

m45 <- lm(behave ~ dpm4 + gap2 + chi2 + gdp, data = df)

m46 <- lm(behave ~ dpm4 + gap2 + chi2 + gini_disp + soc_spend + gdp, data = df)
