...
It weighs in at p = 0.05

```{r nonl_mediation}
# model M - mediator
# this is M2, as we don't expect a nonlinear effet of gini on concern_self

# model Y - outcome
# M26
med1 <- mediate(m2, m26, treat = "gini_disp", mediator = "concern_self", 
                control.value = 40, treatment.value = 50)
summary(med1)

# results from above indicate negative coefficients; this suggests that the 
# squared term is not being dealt with properly

med2 <- mediate(m2, m26, treat = "gini_disp", mediator = "concern_self", 
                control.value = 40, treatment.value = 30)
summary(med2)
