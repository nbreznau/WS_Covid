---
title: "TECHNICAL APPENDIX: The Swedish paradox explained? Investigating the role of economic inequality and risk perceptions in the Novel Coronavirus Pandemic."
output:
...
wda <- "C:/GitHub/WS_Covid" #it already has a 'wd' in the cis envirnoment so reset it here
wd <- wda
...
#### Deaths w 18-day Lead

Data in deaths_long_Ca taken from Johns Hopkins https://github.com/CSSEGISandData/COVID-19

Measure the spread of infection as the 18-day lead deaths. Measure the 'increase in infection' as the ratio from May 1st to May 31st.
...
```{r table2}
knitr::include_graphics(wdir("second_study/Tbl2.png"))
```
...
for (c in countries){
  sim_dfa[paste0("sima_", c)] <- rnorm(1000, mean = finaldf_Ca[finaldf_Ca$cow == c, "concern_self"], sd = finaldf_Ca[finaldf_Ca$cow == c, "concern_self_se"])
}
