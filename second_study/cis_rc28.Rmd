...
ggplot(results_df, aes(x=coeff)) + 
  ...
  labs(title = "Figure 4. Robustness Check of Social Inequality Effect", subtitle = "Re-Analysis of 2,000 datasets simulated with s.e. of the mean by country", caption = "P-values for all 2,000 effects are less than 0.015, with 99.5% of p-values below 0.005. Country case numbers range from ") +
