---
title: "Investigating the role of economic inequality and risk perceptions in the Novel Coronavirus Pandemic."
output:
...
For the instantaneous indirect effects, the robust mean slope is `r rob[1,1]` with a standard error of `r rob[3,1]` and the robust mean intercept is `r rob[1,2]` with a standard error of `r rob[3,2]`
