...
tab_model(m1, m2, m3, p.style = "stars", p.threshold = c(0.10, 0.05, 0.01), show.ci = F, rm.terms = c("(Intercept)"),  dv.labels = c("M1", "M2","M3"), pred.labels = c("Days Since Curve Inflection", "New Cases", "Intervention Speed", "Gini, post", "GDP"))
```
