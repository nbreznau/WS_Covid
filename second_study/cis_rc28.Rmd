...
# create SE max and min for error bars
df$ymin <- df$concern_self - df$concern_self_se
df$ymax <- df$concern_self + df$concern_self_se
...
ggplot(results_df, aes(x=coeff)) + 
  ...
  labs(title = "Figure 4. Robustness Check of Social Inequality Effect", subtitle = "Re-Analysis of 2,000 datasets simulated with s.e. of the mean by country", caption = "P-values for all 2,000 effects are less than 0.015, with 99.5% of p-values below 0.005.\nCountry case numbers range from 20 to 21,087; mean case numbers 1,452. ") +
